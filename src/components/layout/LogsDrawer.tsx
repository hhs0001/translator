        ...
        <Modal.Dialog>
          <Modal.Header className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
                ...
                <Select.Popover>
                  <ListBox>
                    <ListBox.Item key="all" textValue="Todos">Todos</ListBox.Item>
                    <ListBox.Item key="info" textValue="Info">Info</ListBox.Item>
                    <ListBox.Item key="success" textValue="Sucesso">Sucesso</ListBox.Item>
                    <ListBox.Item key="warning" textValue="Warning">Warning</ListBox.Item>
                    <ListBox.Item key="error" textValue="Erro">Erro</ListBox.Item>
                  </ListBox>
                </Select.Popover>
              </Select>
